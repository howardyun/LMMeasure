...
def download(download_dir,modelhub_list):
    ...
    for id in modelhub_list:
        subprocess.run(["git", "clone", "https://huggingface.co/" + id,
...
if __name__ == "__main__":
    ...
    START_MONTH = "2024-01"  # 起始月份，例如 "2024-01"
    END_MONTH = "2024-06"  # 结束月份，例如 "2024-06"
    ...
    for month, models in models_by_month.items():
        ...
        download('download_model/'+month,models)