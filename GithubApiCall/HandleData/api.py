...
def update_csv_with_repo_info(input_csv_path, output_csv_path, token=None):
    with open(input_csv_path, mode='r', newline='', encoding='utf-8') as infile:
        ...
        fieldnames = ['Repository Name', 'Repository URL', 'Description', 'Programming Language', 'Stars', 'Forks', 'Created At']
...
if __name__ == "__main__":
    input_csv_path = './Test/merged.csv'
    output_csv_path = './Test/m.csv'
